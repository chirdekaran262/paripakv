            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="relative h-96 lg:h-[500px] overflow-hidden rounded-2xl bg-white shadow-xl border border-gray-200">
                            <img
                                src={product.imageUrl || "/assets/vegetable.png"}
                                alt={product.name}
                                onError={(e) => {
                                    e.target.onerror = null;
                                    e.target.src = "/assets/vegetable.png";
                                }}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1 border border-blue-200">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-200">
                                <button
                                    onClick={() => {
                                        if (product?.farmerId) {
                                            navigate(`/chat/${product.farmerId}`);
                                        }
                                    }}
