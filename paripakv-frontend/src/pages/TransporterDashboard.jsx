                                                ...
                                                {order.deliveryStatus === "IN_TRANSIT" && (
                                                    <>
                                                        {!selectedFile && !otpSent && !order.proofImageUrl ? (
                                                            // Step 1: File picker
                                                            <label className="flex-1 sm:flex-none bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl">
