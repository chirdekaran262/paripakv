...
export default function TransporterDashboard() {
    ...
    const fetchUserDetails = useCallback(async (buyerId) => {
        ...
        try {
            const response = await axios.get(`http://localhost:8089/users/productDetails?id=${buyerId}`, {
    ...
    const fetchProductDetails = useCallback(async (listingId) => {
        ...
        try {
            const response = await axios.get(`http://localhost:8089/listings/byId?id=${listingId}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const fetchFarmerDetails = useCallback(async (farmerId) => {
        ...
        try {
            const response = await axios.get(`http://localhost:8089/users/productDetails?id=${farmerId}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const fetchOrders = useCallback(async () => {
        try {
            const response = await axios.get(`http://localhost:8089/orders/transporter/getOrder`, {
    ...
    const pickupOrder = async (orderId) => {
        try {
            ...
            await axios.post(`http://localhost:8089/orders/transporter/${orderId}/pickup?transporterId=${userId}`, {}, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const deliverOrder = async (orderId) => {
        try {
            ...
            await axios.post(`http://localhost:8089/orders/transporter/${orderId}/deliver`, {}, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const updateOrderStatus = async (orderId, newStatus) => {
        if (newStatus === "PICKED_UP") {
            ...
            try {
                ...
                await axios.put(`http://localhost:8089/orders/transporter/${orderId}/inTransit`, {}, {
                    headers: { Authorization: `Bearer ${token}` }
                });
    ...
    const handleUploadProof = async (orderId, file) => {
        ...
        try {
            ...
            await axios.post(`http://localhost:8089/orders/${orderId}/proof`, formData, {
                headers: {
