...
public class EmailTemplateService {
    ...
    public String buildFarmerEmailContent(String farmerName, String buyerName, String productName,double totalPrice , String buyerAddress) {
        return "<!DOCTYPE html>" +
                ...
                "    <p>You have received a new order from <strong>" + buyerName + "</strong> for the product <strong>" + productName + "</strong>.</p>" +
                "    <p><strong>Order Quantity:</strong> " + totalPrice + "<br/>" +
                "       <strong>Delivery Address:</strong> " + buyerAddress + "</p>" +
                "    <p>Please confirm or reject this order promptly.</p>" +
    ...
    public String buildBuyerEmailContent(String buyerName, String productName, UUID productId) {
        return "<!DOCTYPE html>" +
                ...
                "    <p>Your order for <strong>" + productName + "</strong> has been placed and is awaiting confirmation from the farmer.</p>" +
                "    <p><strong>Product ID:</strong> " + productId + "</p>" +
                "    <p>We will notify you once the farmer confirms or rejects the order.</p>" +
                "    <div class='footer'>" +
                "      Thank you for using Paripakv.<br/>" +
                "      © 2025 Paripakv. All rights reserved." +
                "    </div>" +
                "  </div>" +
                "</body>" +
    ...
    public String buildBuyerOrderConfirmedContent(String buyerName, String productName, UUID orderId, double quantity) {
        return "<!DOCTYPE html>" +
                ...
                "    <p>Hello <strong>" + buyerName + "</strong>,</p>" +
                "    <p>Your order for <strong class='highlight'>" + productName + "</strong> (<strong>" + quantity + " kg</strong>) has been confirmed by the farmer.</p>" +
                "    <p><strong>Order ID:</strong> " + orderId + "</p>" +
                "    <p>The farmer will now proceed with the delivery. You will be notified once the produce is picked up.</p>" +
                "    <div class='footer'>" +
                "      Thank you for using Paripakv.<br/>" +
                "      © 2025 Paripakv. All rights reserved." +
                "    </div>" +
    ...
    public String buildBuyerPickupEmailContent(String buyerName, String productName, UUID orderId, String transporterName, LocalDateTime pickupTime) {
        return "<!DOCTYPE html>" +
                ...
                "<p>Hello <strong>" + buyerName + "</strong>,</p>" +
                "<p>Your order for <strong class='highlight'>" + productName + "</strong> (Order ID: <strong>" + orderId + "</strong>) has been picked up by the transporter <strong class='highlight'>" + transporterName + "</strong>.</p>" +
                "<p>Pickup Time: <strong class='highlight'>" + pickupTime + "</strong></p>" +
                "<p>The delivery is now on its way!</p>" +
    ...
    public String buildFarmerPickupEmailContent(String farmerName, String productName, UUID orderId, String transporterName, LocalDateTime pickupTime) {
        return "<!DOCTYPE html>" +
                ...
                "<p>Hello <strong>" + farmerName + "</strong>,</p>" +
                "<p>Your produce for <strong class='highlight'>" + productName + "</strong> (Order ID: <strong>" + orderId + "</strong>) has been picked up by the transporter <strong class='highlight'>" + transporterName + "</strong>.</p>" +
                "<p>Pickup Time: <strong class='highlight'>" + pickupTime + "</strong></p>" +
